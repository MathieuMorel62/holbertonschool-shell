...
mathieu@production-503e7013:~/shell/fun_with_the_shell$ ls -Rla
    .:
    total 28
    drwxrwxr-x 3 mathieu mathieu 4096 Jan 20 03:35 .
    drwxrwxr-x 3 mathieu mathieu 4096 Jan 20 02:58 ..
    -rwxr--r-- 1 mathieu mathieu 43 Jan 20 02:59 0-commas
    -rwxr--r-- 1 mathieu mathieu 47 Jan 20 02:50 1-empty_casks
    -rwxrw-r-- 1 mathieu mathieu 68 Jan 20 03:35 2-gifs
    ...
    -rw-rw-r-- 1 mathieu mathieu 0 Jan 20 03:22 index.html
    -rw-rw-r-- 1 mathieu mathieu 0 Jan 20 03:23 main.gif
    -rw-rw-r-- 1 mathieu mathieu 0 Jan 20 03:23 Electra_napping.gif

    ./test_dir/rep.gif:
    total 8
    drwxrwxr-x 2 mathieu mathieu 4096 Jan 20 03:23 .
    drwxrwxr-x 4 mathieu mathieu 4096 Jan 20 03:42 ..
    mathieu@production-503e7013:~/shell/fun_with_the_shell$ ./24-gifs
    .horrible_selfie
    cat
    docker
    Electra_napping
...
```c
mathieu@ubuntu:/tmp/0x02$ wget https://s3.amazonaws.com/alx-intranet.hbtn.io/public/nasa_19950801.tsv
...
mathieu@ubuntu:/tmp/0x02$ head nasa_19950801.tsv
...
mathieu@ubuntu:/tmp/0x02$ ./26-the_biggest_fan < nasa_19950801.tsv 
edams.ksc.nasa.gov
130.110.74.81
